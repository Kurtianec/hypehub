    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", fontSize: "36px", fontWeight: 900, color: "#fff", letterSpacing: "-2px" }}>
              <span style={{ color: "#8E1537" }}>Hype</span>Hub
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", fontSize: "64px", fontWeight: 900, color: "#8E1537", lineHeight: 1.05, letterSpacing: "-2px" }}>
            social accounts
          </div>
        ...
        <div style={{ display: "flex", gap: "32px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 20px", background: "rgba(255,255,255,0.05)", border: "2px solid #8E153740", borderRadius: "8px" }}>
            <div style={{ display: "flex", width: "10px", height: "10px", background: "#8E1537", borderRadius: "50%" }} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 20px", background: "rgba(255,255,255,0.05)", border: "2px solid #8E153726", borderRadius: "8px" }}>
            <div style={{ display: "flex", width: "10px", height: "10px", background: "#8E1537", borderRadius: "50%" }} />
