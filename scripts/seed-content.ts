...
async function main() {
  ...
  const reviews = [
    ...
    },
    {
      ...
      name: "Мария К.",
      rating: 5,
      text: "Брала VK группу 10K для своего бизнеса. Группа живая, участники активные, сразу начала постить рекламу своих товаров. Оплата через USDT — быстро и удобно. Поддержка ответила на все вопросы за 5 минут.",
    ...
    },
    {
      ...
      name: "Никита Д.",
      rating: 5,
      text: "Брал Telegram 1K канал для запуска. За 1490₽ — отличная цена. Подписчики живые, просмотры есть. Оплата TON моментальная, данные пришли за секунду. Сервис реально работает 24/7, проверял ночью.",
...
Покупка TikTok аккаунта — это инвестиция, которая окупается при правильном подходе. Выбирайте проверенные маркетплейсы с гарантией, оплачивайте криптой для анонимности, и сразу после получения настраивайте безопасность. Удачи!`,
...
Покупка VK группы — это инвестиция в свой бизнес. Выбирайте проверенный маркетплейс с гарантией, проверяйте активность и тематику, оплачивайте криптой. Правильно выбранная группа окупится за 1-3 месяца активной работы. Удачи!`,
      tags: "vk,бизнес,покупка группы,чек-лист",
      published: true,
    },
    {
      id: "post_4",
      slug: "oplata-kriptovalyutoj-polnoe-rukovodstvo",
      title: "Оплата криптовалютой: полное руководство",
      excerpt: "Подробное руководство по оплате аккаунтов криптовалютой. BTC, USDT TRC-20, TON — что выбрать, как перевести, комиссии, скорость зачисления, безопасность.",
      content: `# Оплата криптовалютой
...
Оплата криптовалютой — самый анонимный и безопасный способ покупки аккаунтов. Выбирайте монету исходя из суммы: TON для небольших, USDT для средних, BTC для крупных. В ХайпХаб все три монеты доступны в любом товаре. Удачных покупок!`,
      tags: "оплата,криптовалюта,btc,usdt,ton,руководство",
      published: true,
    },
    {
      id: "post_5",
