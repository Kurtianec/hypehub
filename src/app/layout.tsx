...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "купить аккаунт соцсети",
    "купить аккаунт с подписчиками",
    "купить группу ВК с подписчиками",
    "купить канал YouTube с подписчиками",
    "купить Telegram канал",
    "купить Telegram группу",
    "купить TikTok аккаунт с подписчиками",
    "купить страницу Instagram с подписчиками",
    "купить аккаунт с гарантией",
  ],
