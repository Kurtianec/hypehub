  ...
  return (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        <linearGradient id="classic-light" x1="17" y1="29" x2="48" y2="49" gradientUnits="userSpaceOnUse"><stop stopColor="#FFFFFF"/><stop offset="1" stopColor="#E8EAED"/></linearGradient>
      </defs>
