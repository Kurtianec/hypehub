...
export default async function OptPage() {
  ...
  const tiers = [
    { count: "3+", discount: "10%", color: "#8E1537", features: ["Скидка 10% на заказ", "Приоритетная поддержка", "Резерв 24 часа"] },
    { count: "5+", discount: "20%", color: "#8E1537", features: ["Скидка 20% на заказ", "Персональный менеджер", "Резерв 48 часов", "Помощь с настройкой"] },
    { count: "10+", discount: "30%", color: "#8E1537", features: ["Скидка 30% на заказ", "Эксклюзивные товары", "Безлимитный резерв", "API доступ", "Отложенная оплата"] },
  ];
      ...
      <main className="flex-1 pt-28 md:pt-32 pb-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-[#0E0E0E] border-2 border-[#8E1537] p-5"
              ...
              <div className="flex items-center gap-3 mb-3">
                <Package className="w-5 h-5 text-[#8E1537]" strokeWidth={2.5} />
                <h2 className="font-black uppercase tracking-tight font-mono text-sm text-[#8E1537]">{"// РЕЗЕРВИРОВАНИЕ"}</h2>
              </div>
            ...
            <div className="bg-[#0E0E0E] border-2 border-[#8E1537] p-5"
              style={{ clipPath: "polygon(0 0, calc(100% - 14px) 0, 100% 14px, 100% 100%, 14px 100%, 0 calc(100% - 14px))" }}>
              <div className="flex items-center gap-3 mb-3">
                <TrendingUp className="w-5 h-5 text-[#8E1537]" strokeWidth={2.5} />
                <h2 className="font-black uppercase tracking-tight font-mono text-sm text-[#8E1537]">{"// КАК_РАБОТАЕТ"}</h2>
              </div>
          ...
          <div className="text-center bg-[#0E0E0E] border-2 border-[#8E1537] p-6 md:p-8"
            ...
            <Shield className="w-10 h-10 mx-auto mb-3 text-[#8E1537]" strokeWidth={2.5} />
