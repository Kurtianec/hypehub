    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg, #0A0A0A 0%, #111318 100%)", padding: "60px", fontFamily: "sans-serif" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <div style={{ display: "flex", fontSize: "24px", color: "#8E1537", fontFamily: "monospace", letterSpacing: "3px" }}>// VK</div>
          <div style={{ display: "flex", fontSize: "68px", fontWeight: 900, color: "#fff", lineHeight: 1, letterSpacing: "-2px" }}>Buy VK Group</div>
          <div style={{ display: "flex", fontSize: "68px", fontWeight: 900, color: "#8E1537", lineHeight: 1, letterSpacing: "-2px" }}>with Subscribers</div>
