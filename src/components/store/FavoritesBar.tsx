            ...
            <div className="flex items-center justify-between p-4 border-b-2 border-[#1F1F1F] bg-[#0A0A0A]">
              ...
              <div className="flex items-center gap-1">
                {favorites.length > 0 && (
                  <button
                    onClick={onClear}
                    className="w-8 h-8 hover:bg-[#8E1537]/10 flex items-center justify-center text-[#8E1537]"
                    aria-label="Очистить"
                    title="Очистить всё"
                  >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="w-7 h-7 flex-shrink-0 hover:bg-[#8E1537]/10 flex items-center justify-center text-[#8E1537]"
